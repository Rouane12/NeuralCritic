...
def main()->int:
    ...
    completeness_checks={
        'Games Directory text-card JS is cache-pinned': 'assets/games-directory.js?v=20260905-textcards1' in html,
    ...
    if failures:
        ...
        return 1
    print('Games Directory audit passed: canonical links, verified release grouping, consistent text-first cards, light-mode contrast, filters, responsive behavior and analytics are wired.')
    return 0
